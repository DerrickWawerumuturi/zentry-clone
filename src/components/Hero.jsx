        ...
        <div className={"relative h-dvh w-screen overflow-x-hidden"}>
            ...
            <div id={"video-frame"} className={"relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75"}>
                ...
                <video
                    ...
                    loop
                    muted
                    className={"absolute left-0 to-0 size-full object-cover"}
                    onLoadedData={handleVideoLoad}
                />

                <h1 className={"special-font hero-heading bottom-5 absolute right-5 z-40 text-blue-75"}>G<b>a</b>ming
                </h1>
            ...
            <h1 className={"special-font hero-heading bottom-5 absolute right-5 text-black"}>G<b>a</b>ming</h1>
